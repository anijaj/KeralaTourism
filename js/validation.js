...
function validLogin() 
    {
        ...
        {   
            emailLoginError.innerText = "Valid email";
...
function validSignupEmail() 
    {
        ...
        {   
            emailSignupError.innerText = "Valid email";
...
function validNumber()
{
        ...
        {
            numberError.innerText = "Invalid Format! Please re-enter phone number (10 digit number)";
...
function validPass()
{
    ...
    {
        passError.innerText = "Password must contain a minimum of 8 characters with at least one uppercase, lowercase character and number";
...
{   
    ...
    {
        inputPass.style.border = "orange 1px solid";
